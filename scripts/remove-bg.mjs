...
const input = path.join(root, 'public/images/B&G.png')
const outputs = [
  path.join(root, 'public/images/bg-couple.png'),
  path.join(root, 'public/images/couple-center.png'),
]
...
const pngBuffer = await sharp(Buffer.from(pixels), { raw: { width, height, channels } })
